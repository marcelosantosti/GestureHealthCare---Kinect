package br.com.facdombosco.gesturehealthcare.model.gestures.gestureparts.swipe.left
{
	...
	public class SwipeLeftGesturePart2 implements IGesturePart
	{
		public function checkGesture(user : User) : int
		{
			if (user.rightHand.positionRelative.z < user.rightElbow.positionRelative.z && user.leftHand.positionRelative.y < user.leftHip.positionRelative.y)
			{
				...
				{
					if (user.rightHand.positionRelative.x < user.rightShoulder.positionRelative.x && user.rightHand.positionRelative.x > user.leftShoulder.positionRelative.x)
					{
