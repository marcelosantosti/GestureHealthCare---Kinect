package br.com.facdombosco.gesturehealthcare.model.gestures.gestureparts.strech.right
{
	...
	public class StrechRigthGesturePart implements IGesturePart
	{
		...
		{
			if (user.rightHand.positionRelative.x > user.head.positionRelative.x + 0.50)
			{
				if (this._timer == null)
				{
					this._seconds = 0;
