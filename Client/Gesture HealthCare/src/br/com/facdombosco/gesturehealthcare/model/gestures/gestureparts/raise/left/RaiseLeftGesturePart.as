package br.com.facdombosco.gesturehealthcare.model.gestures.gestureparts.raise.left
{
	...
	public class RaiseLeftGesturePart implements IGesturePart
	{
		...
		{
			if (user.leftHand.positionRelative.y > user.head.positionRelative.y + 0.15)
			{
				if (this._timer == null)
				{
					this._seconds = 0;
