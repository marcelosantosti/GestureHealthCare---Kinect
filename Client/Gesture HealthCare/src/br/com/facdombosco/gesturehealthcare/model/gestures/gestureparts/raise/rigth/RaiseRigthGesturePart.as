package br.com.facdombosco.gesturehealthcare.model.gestures.gestureparts.raise.rigth
{
	...
	public class RaiseRigthGesturePart implements IGesturePart
	{
		...
		{
			if (user.rightHand.positionRelative.y > user.head.positionRelative.y + 0.15)
			{
				if (this._timer == null)
				{
					this._seconds = 0;
